  ...
  return (
    <div className='landingPageMenuDiv'>
            ...
            <div className='desktopMenuLinkDiv'>
                    ...
                    <Link to='/work' className='fontWhite desktopLinkDiv'  ><span >Work</span>
                     <div className='arrowDiv'><i className='fa-solid fa-arrow-up'></i></div>
                    </Link>
            ...
            <div className='desktopMenuLinkDiv'>
                    ...
                    <Link to='' className='fontWhite desktopLinkDiv activePage'><span>About</span>
                     <div className='arrowDiv'><i className='fa-solid fa-arrow-up'></i></div>
                    </Link>
            ...
            <ul className='socialLinkUl responsiveMenuSocials'>
                        <li className='fontWhite menuList'>
                              ...
                              <a href='https://twitter.com/iamlumiwon' className='LinkGeneral LinkListContainer'><i className='fa-brands fa-twitter fa-brands-list fa-brands-list-responsive'></i> </a>
                            
                        </li>
                        <li className='fontWhite menuList'>
                            
                              <a href='https://www.linkedin.com/in/daniel-adesanya-27296813b/' className='LinkGeneral LinkListContainer'><i className='fa-brands fa-linkedin  fa-brands-list fa-brands-list-responsive'></i></a>
                            
                        </li>
                        <li className='fontWhite menuList'>
                            
                              <a href='https://github.com/frontendrockstarng' className='LinkGeneral LinkListContainer'><i className='fa-brands fa-github-square fa-brands-list fa-brands-list-responsive'></i> </a>
                            
                        </li>
                        <li className='fontWhite menuList'>
                            
                              <a href='mailto:danadesanya96@gmail.comgithub.io' className='LinkGeneral LinkListContainer'><i className='fa-regular fa-envelope fa-brands-list fa-brands-list-responsive'></i> </a>
        ...
        <div className='desktopMenu'>
            ...
            <div className='desktopMenuLinkDiv'>
                    ...
                    <Link to='' className='fontWhite desktopLinkDiv aboutActive' ><span>About</span>
                     <div className='arrowDiv'><i className='fa-solid fa-arrow-up'></i></div>
                    </Link>
